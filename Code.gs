...
const productName = "B2B Commerce on Lightning Experience";
...
const requestedTrainingDateColumnIndex = 3;
const firstNameColumnIndex = 4;
const lastNameColumnIndex = 5;
const countryColumnIndex = 6;
const activeOpportunityColumnIndex = 7;
const prerequisitesCompleteColumnIndex = 8;
  ...
  if(submission.requestedTrainingDate === 'Self-Enablement (Partner Learning Camp Migration)')
    {
      ...
      + "If you do not have access to the <a href=\"" + partnerCommunity + "\">Partner Community</a> or appropriate  <a href=\"" + b2bLexChatterGroup + "\">Chatter Group</a> you should work with your Partner Admin to establish that as soon as possible."
    });
    }
